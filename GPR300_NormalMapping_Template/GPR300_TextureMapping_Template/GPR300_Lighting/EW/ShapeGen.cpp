...
namespace ew {
	...
	void createSphere(float radius, int numSegments, MeshData& meshData)
	{
		...
		meshData.vertices.push_back({ glm::vec3(0,topY,0),glm::vec3(0,1,0), glm::vec2(0,0), glm::vec3(1,0,0) });
		...
		meshData.vertices.push_back({ glm::vec3(0,bottomY,0), glm::vec3(0,-1,0), glm::vec2(1,1), glm::vec3(-1,0,0) });
	...
	void createCylinder(float height, float radius, int numSegments, MeshData& meshData)
	{
		...
		//VERTICES
		//Top cap (facing up)
		meshData.vertices.push_back(Vertex(glm::vec3(0, halfHeight, 0), glm::vec3(0, 1, 0), glm::vec2(0, 0), glm::vec3(1, 0, 0)));
		for (int i = 0; i <= numSegments; i++)
		{
			...
			meshData.vertices.push_back(Vertex(pos, glm::vec3(0, 1, 0), glm::vec2(pos.x, pos.y), glm::vec3(0, 0, 1)));
		}
		...
		for (int i = 0; i <= numSegments; i++)
		{
			...
			meshData.vertices.push_back(Vertex(pos, glm::vec3(0, -1, 0), glm::vec2(pos.x, pos.z), glm::vec3(0, 0, -1)));
		}

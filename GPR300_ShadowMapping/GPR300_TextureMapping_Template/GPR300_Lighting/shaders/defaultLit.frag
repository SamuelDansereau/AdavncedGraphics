...
vec3 calcDirectionalLight(DirLight dl, vec3 norm)
{
    vec3 blinnPhong = calcBlinnPhong(dl.intensity, dl.dir, norm);
...
void main(){    
    ...
    vec3 lightColor = calcDirectionalLight(_dLight, normal);    //calcPointLight(_pLight, normal);
